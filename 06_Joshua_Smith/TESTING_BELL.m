...
if feeder_num ==0
    addpath(strcat(s_b,'\03_OpenDSS_Circuits\Bellhaven_Circuit_Opendss'));
    root1= 'Bell';
...
%--------------------------------------------------------------------------------
    if time_int == 60
        ckt_direct_prime=strcat(s_b,'\03_OpenDSS_Circuits\Bellhaven_Circuit_Opendss\Master_24hr_60sec.dss');
    elseif time_int == 5
        ckt_direct_prime=strcat(s_b,'\03_OpenDSS_Circuits\Bellhaven_Circuit_Opendss\Master_24hr_5sec.dss');
    end
end
