...
h.f = figure('units','characters','toolbar','none','menu','none',...
    'Color',bk_color,'Position',[258 14 126.6 57]);
%%
%Add all text:
h.st(1) = uicontrol('style','text','unit','characters','position',[2.2 52.308 43.4 2.385],...
    'min',0,'max',1,'fontsize',12,'string','Name of Running Machine:',...
    'backgroundColor',[0.973 0.973 0.973],'FontAngle','italic');
h.st(2) = uicontrol('style','text','unit','characters','position',[2.4 46.692 12.4 1.615],...
    'min',0,'max',1,'fontsize',12,'string','DEC:',...
    'backgroundColor',[0.973 0.973 0.973],'FontWeight','bold');
h.st(3) = uicontrol('style','text','unit','characters','position',[2.4 39 12.4 1.615],...
    'min',0,'max',1,'fontsize',12,'string','DEP:',...
    'backgroundColor',[0.973 0.973 0.973],'FontWeight','bold');
h.st(4) = uicontrol('style','text','unit','characters','position',[2.4 31.308 12.4 1.615],...
    'min',0,'max',1,'fontsize',12,'string','EPRI:',...
    'backgroundColor',[0.973 0.973 0.973],'FontWeight','bold');
h.st(5) = uicontrol('style','text','unit','characters','position',[23.5 54.846 80.4 1.308],...
...
%%
%Add all popupmenu:
h.ppm(1) = uicontrol('style','popup','units','characters','position',[58.6 48.769 54 5.846],...
    'fontsize',12,'string',{'JML''s Home Computer','JML''s Laptop Computer','Brian''s Computer','Shane''s Computer'},...
    'BackgroundColor',[1 1 1]);
    %'callback',@setmap);
h.ppm(2) = uicontrol('style','popup','units','characters',...
     'position',[6 14.769 54 5.846],'string',{'Top of Voltage band on caps/vregs','Bottom of Voltage band on caps/vregs','Steady-State','Extreme UP-ramping','Extreme DOWN-ramping'},...
     'backgroundcolor',[0.973 0.973 0.973],'Fontsize',12);
h.ppm(3) = uicontrol('style','popup','units','characters',...
     'position',[6 11.846 54 5.846],'string',{'hold','hold'},...
     'backgroundcolor',[0.973 0.973 0.973],'Fontsize',12);
h.ppm(3) = uicontrol('style','popup','units','characters',...
     'position',[69.8 14.769 54 5.846],'string',{'Shelby,NC','Murphy,NC','Taylorsville,NC'},...
     'backgroundcolor',[0.973 0.973 0.973],'Fontsize',12);
h.ppm(4) = uicontrol('style','popup','units','characters',...
    'position',[69.8 11.846 54 5.846],'string',{'hold','hold'},...
    'backgroundcolor',[0.973 0.973 0.973],'Fontsize',12);
h.ppm(5) = uicontrol('style','popup','units','characters',...
    'position',[5.8 5.769 54 5.846],'string',{'(1) Day, 10:00 to 16:00','(1) Week, 10:00 to 16:00','(1) Month','(1) Season','(1) Year'},...
    'backgroundcolor',[0.973 0.973 0.973],'Fontsize',12);
h.ppm(6) = uicontrol('style','popup','units','characters',...
