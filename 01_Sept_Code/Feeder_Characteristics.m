...
AMP(1,:) = [2.61478509139000,3.96475087115000,4.94568441401000,0.0705815318900000,0,0];
AMP(2,:) = [2.35654951750000,1.64945417434000,2.77824294665000,0.104073428790000,0,0];
AMP(3,:) = [10.4713938016800,6.00718492073000,1.71739487948000,0,0,0];
AMP(4,:) = [6.80965130234758,1.34931346448420,0,4.52746072052400,1.89518155000000e-07,0];
AMP(5,:) = [0.897575479887360,0.0148394610546550,2.18165462807851,4.76185648134089,0,0];
AMP(6,:) = [0.326982853384776,2.17479850000000e-05,0.545888088691032,0.511174084279200,3.79036310000000e-06,0];
%{
sum = 0;
for j=1:1:6
    for i=1:1:6
